...
export default function Archiving() {
  ...
  return (
    <div className="w-screen h-full flex flex-col items-center pb-[95px]">
      <strong className="text-[35px] text-black dark:text-white mt-[92px]">
        ARCHIVING
      </strong>
      <div className="flex gap-[14px] mt-[104px]">
        <div className="flex flex-col gap-[15px] w-[400px] h-[242px] rounded-[10px] bg-lightBg dark:bg-darkBg pt-[23px] pl-[32px]">
          {theme === "light" ? (
