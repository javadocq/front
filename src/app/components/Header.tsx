  ...
  return (
    <nav className="flex w-screen box-border border-b-2 px-10 justify-between items-center h-20">
      ...
      <div className="flex gap-6">
        ...
        {/* lg:hiddne : 화면이 1024px 이상 일때 안 보이게 하기 */}
        {toggle ? (
          <ul className="lg:hidden flex flex-col box-border border-1 border-gray-300 rounded-lg text-xl fixed top-24 right-5 items-center gap-2 box-border border-4 px-4 py-2 z-10 bg-lightBg">
            <li
